...
export const useCadStore = create<CadState>((set, get) => ({
    ...
    setProjectTree: (items) => set({ projectTree: items }),
    ...
    setSmartSnapping: (enabled) => set({ smartSnapping: enabled }),
    setRadioAngle: (angle) => set({ radioAngle: angle }),
    setMeasuringScale: (scale) => set({ measuringScale: scale }),
    purge: () => { },

    pushSnapshot: (json) => set((state) => {
